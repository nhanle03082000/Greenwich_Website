...
// const informationUser = require("../model/information.model");
...
const inforController = require("./../controllers/information.controller");
router.post("/create", inforController.create);
router.post("/checkout", inforController.checkout);
router.post("/checkin", inforController.checkin);
router.post("/getTime", inforController.getTime);
router.get("/getAlltime/:id", inforController.getAlltime);
router.get("/", inforController.list);
module.exports = router;
