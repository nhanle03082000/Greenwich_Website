...
router.get("/aUser/:id", authController.aUser);
router.put("/update_pass/:id", authController.update_pass);
router.put("/update_pass_user/:id", authController.update_pass_user);
