...
export default function Department() {
  ...
  //context
  const {
    departSate: { departments, departmentsLoading },
    getAllDepartments,
    deleteDepart,
        ...
        <Table sx={{}} aria-label="custom pagination table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="left">Macc Address</TableCell>
          ...
          <TableBody>
            {(rowsPerPage > 0
              ...
              <TableRow key={data._id}>
                ...
                <TableCell align="left">{data.macAddress}</TableCell>
                <TableCell align="left">{data.uniqueId}</TableCell>
                <TableCell align="center">
                  <IconButton
                    onClick={() =>
                      navigate(`/home/update-department/${data._id}`)
                    }
                  >
                  ...
                  <IconButton
                    onClick={() =>
                      removeDepartment(data._id, data.name_department)
                    }
                  >
